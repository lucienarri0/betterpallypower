...
PALLYPOWER_MANUALPALLY = L["Manual Paladin"]
PALLYPOWER_MANUALPALLY_DESC = L["Type the name of a Paladin who is not in the group yet."]
PALLYPOWER_MANUALPALLY_ADD = L["Add"]
PALLYPOWER_MANUALPALLY_ADD_DESC = L["Add this name as a temporary Paladin for blessing assignments."]
PALLYPOWER_MANUALPALLY_REMOVE = L["Remove"]
PALLYPOWER_MANUALPALLY_REMOVE_DESC = L["Remove this temporary Paladin only if the player is not in the group."]
PALLYPOWER_MANUALMEMBER = L["Temporary Member"]
PALLYPOWER_MANUALMEMBER_DESC = L["Type the name of a player who is not in the group yet."]
PALLYPOWER_MANUALMEMBER_CLASS_DESC = L["Choose the class for this temporary member."]
PALLYPOWER_MANUALMEMBER_ADD_DESC = L["Add this name as a temporary member for blessing assignments."]
PALLYPOWER_MANUALMEMBER_REMOVE_DESC = L["Remove this temporary member only if the player is not in the group."]
PALLYPOWER_MANUALMEMBER_GUILD = L["Guild"]
