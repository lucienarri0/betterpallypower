...
L["Add"] = "Ajouter"
L["Manual Paladin"] = "Paladin manuel"
L["Temporary Member"] = "Membre temporaire"
L["Remove"] = "Supprimer"
L["Type the name of a Paladin who is not in the group yet."] = "Saisissez le nom d'un paladin qui n'est pas encore dans le groupe."
L["Add this name as a temporary Paladin for blessing assignments."] = "Ajoute ce nom comme paladin temporaire pour les attributions de bénédictions."
L["Remove this temporary Paladin only if the player is not in the group."] = "Supprime ce paladin temporaire uniquement si le joueur n'est pas dans le groupe."
L["Type the name of a player who is not in the group yet."] = "Saisissez le nom d'un joueur qui n'est pas encore dans le groupe."
L["Choose the class for this temporary member."] = "Choisissez la classe de ce membre temporaire."
L["Add this name as a temporary member for blessing assignments."] = "Ajoute ce nom comme membre temporaire pour les attributions de bénédictions."
L["Remove this temporary member only if the player is not in the group."] = "Supprime ce membre temporaire uniquement si le joueur n'est pas dans le groupe."
L["Guild"] = "Guilde"
L["Guild Rank Management"] = "Gestion des rangs de la guilde"
L["Guild Ranks"] = "Rangs de la guilde"
L["Choose a max-level guild member to add as a temporary member."] = "Choisissez un membre de guilde niveau maximum à ajouter comme membre temporaire."
L["No max-level guild members found."] = "Aucun membre de guilde niveau maximum trouvé."
...
L["%s is already in your group and cannot be removed as a temporary member."] = "%s est déjà dans votre groupe et ne peut pas être supprimé comme membre temporaire."
L["%s is not a manual Paladin."] = "%s n'est pas un paladin manuel."
L["%s is not a temporary member."] = "%s n'est pas un membre temporaire."
--[[Translation missing --]]
