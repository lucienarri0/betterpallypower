...
L["Temporary Member"] = "Temporary Member"
L["Remove"] = "Remove"
...
L["Type the name of a player who is not in the group yet."] = "Type the name of a player who is not in the group yet."
L["Choose the class for this temporary member."] = "Choose the class for this temporary member."
L["Add this name as a temporary member for blessing assignments."] = "Add this name as a temporary member for blessing assignments."
L["Remove this temporary member only if the player is not in the group."] = "Remove this temporary member only if the player is not in the group."
L["Guild"] = "Guild"
L["Guild Rank Management"] = "Guild Rank Management"
L["Guild Ranks"] = "Guild Ranks"
L["Choose a max-level guild member to add as a temporary member."] = "Choose a max-level guild member to add as a temporary member."
L["No max-level guild members found."] = "No max-level guild members found."
L["No guild ranks found."] = "No guild ranks found."
L["Select the guild ranks shown in the guild member dropdown. Leave all ranks unselected to show every rank."] = "Select the guild ranks shown in the guild member dropdown. Leave all ranks unselected to show every rank."
L["You are not in a guild."] = "You are not in a guild."
L["Import from MRT"] = "Import from MRT"
L["Choose a MRT raid group to import as temporary members."] = "Choose a MRT raid group to import as temporary members."
L["No MRT raid groups found."] = "No MRT raid groups found."
L["MRT Raid Group"] = "MRT Raid Group"
L["MRT import skipped %s: class not found."] = "MRT import skipped %s: class not found."
L["Imported %d member(s) from MRT raid group %s."] = "Imported %d member(s) from MRT raid group %s."
L["Skipped %d MRT member(s) already in your group."] = "Skipped %d MRT member(s) already in your group."
L["Select a class for this temporary member."] = "Select a class for this temporary member."
...
L["%s is already in your group and cannot be removed as a temporary member."] = "%s is already in your group and cannot be removed as a temporary member."
L["%s is not a manual Paladin."] = "%s is not a manual Paladin."
L["%s is not a temporary member."] = "%s is not a temporary member."
...
L["Main BetterPallyPower Settings"] = "Main BetterPallyPower Settings"
